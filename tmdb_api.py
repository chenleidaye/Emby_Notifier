...
def get_movie_poster(tmdb_id):
    ...
    if movie_details:
        ...
        if poster_path:
            poster_url = f"https://static-mdb.v.geilijiasu.com/t/p/w500{poster_path}"
...
def get_movie_backdrop_path(tmdb_id):
    ...
    if movie_details:
        ...
        if backdrop_path:
            return f"https://static-mdb.v.geilijiasu.com/t/p/w500{backdrop_path}", None
...
def get_tv_episode_still_paths(tmdb_id, season_number, episode_number):
    ...
    if episode_details:
        ...
        if still:
            return f"https://static-mdb.v.geilijiasu.com/t/p/w500{still}", None
